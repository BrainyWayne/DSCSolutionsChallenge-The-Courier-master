        ...
        children: <Widget>[
          ...
          Align(
            ...
            child: GestureDetector(
              onTap: (){
                _currentLocation(6.6688, -1.5684);
              },
              child: Container(
                margin: EdgeInsets.only(bottom: 70, right: 10),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(50),
                    color: whiteColor
                ),
                child: Icon(Icons.call_missed_outgoing, color: blackColor,),
                height: 50,
                width: 50,
              ),
            ),
